...
export default {
  ...
  methods: {
    getRandomImgArr() {
      const getRandomImgArr = Interceptor('get', '/illusts/recommendRandom/' + this.xRestrict);
    ...
    getComment(illustsId) {
      this.$router.push("/illusts/" + illustsId);
    }
  },
  mounted() {
